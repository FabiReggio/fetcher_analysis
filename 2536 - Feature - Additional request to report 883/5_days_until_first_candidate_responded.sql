-- Days until first candidate responded --
...
SELECT 
    ...
    c.id as "Contract Id",
    TIMESTAMPDIFF(DAY,c.start_date,min(ce.created)) AS "Days until first candidate responded" -- ce.created - contract start date
FROM contracts c
