-- Time to get 10 emailed candidates --
...
select
	...
	datediff(rank_table.event_date, rank_table.contract_start_date) as "Time to get 10 emailed candidates"
from (
	select
		data_table.*
		, @order_rank := IF(
	...
	from (
		...
		where 1=1 
		and ce.event_id in (1,2) -- Email sent
