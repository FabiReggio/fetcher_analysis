-- --------------------- Contacted by Candidate's Ethnicity Group -----------------------------------------

SELECT 
ceth.ethnicity_label as "Ethnicity",
...
JOIN candidate_ethnicity ceth ON ceth.candidate_id = bc.caliber_id
