-- Time to get 50 emailed candidates --
...
select
	...
	datediff(rank_table.event_date, rank_table.contract_start_date) as "Time to get 50 emailed candidates"
from (
	select
		data_table.*
		, @order_rank := IF(
